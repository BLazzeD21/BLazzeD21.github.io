...
export const skillsList = [
	{
		...
		description:
			"It'm a front-end web developer with experience in HTML, CSS, CSS-preprocessors, module bundlers, CSS-framework, CSS Architecture (BEM), JS, TS, React, state Containers.",
	},
	{
		id: 2,
