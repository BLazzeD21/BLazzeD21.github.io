...
gulp.task("html", function () {
	return gulp.src("src/html/**/*").pipe(gulp.dest("build/html")).pipe(browserSync.stream());
});

gulp.task("scripts", function () {
	return gulp.src("src/js/**/*.js").pipe(gulp.dest("build/js")).pipe(browserSync.stream());
});
...
gulp.task("start", gulp.parallel("watch", "server", "styles", "scripts", "fonts", "icons", "index", "images", "html"));

gulp.task("build", gulp.parallel("styles", "scripts", "fonts", "icons", "index", "images", "html"));
